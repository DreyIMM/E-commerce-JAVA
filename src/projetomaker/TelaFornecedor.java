...
public class TelaFornecedor extends javax.swing.JFrame {
   ...
   */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listagem dos forncedores no sistema");
   ...
   // Método do botão de inclusão
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        if (lista.getSelectedIndex() != 0) {
            ...
            // o trim() é necessário para eliminar os espaços na conversão
            TelaDadosFornecedor tdados = new TelaDadosFornecedor(2, Integer.parseInt(id.trim()));
            tdados.setVisible(true);
            // Configura os comonentes que serão liberados ou restringidos
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if (lista.getSelectedIndex() != 0) {
            ...
            // o trim() é necessário para eliminar os espaços na conversão
            TelaDadosFornecedor tdados = new TelaDadosFornecedor(3, Integer.parseInt(id.trim()));
            tdados.setVisible(true);
            // Configura os comonentes que serão liberados ou restringidos
        } // Verificação de segurança
        else {
  ...
  private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    public boolean preencherLista() {
        ...
        try {
            ...
            String linha = String.format("%3s|%-15s|%-15s|%10s|%10s|%10s|%5s", 
                    "Id", "Responsavel", "Nome", "Telefone", "Categoria" , "Empresa", "Cidade");
            // Adiciona a linha ao ArrayList
            ar.add(linha);
            // Enquanto houver registros
            while (rs.next()) {
                // Formata a linha de registros da lista
                linha = String.format("%3s|%-15s|%-15s|%10s|%10s|%10s|%5s", rs.getString("id"),
                        rs.getString("responsavel"), rs.getString("nome") ,rs.getString("telefone"),  
                        rs.getString("ramo"), rs.getString("empresa"), rs.getString("cidade"));
                // Adiciona a linha ao ArrayList
                ar.add(linha);
            }
